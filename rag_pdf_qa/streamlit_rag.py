...
# Ensure event loop exists (needed for Streamlit async stuff)
try:
...
# Page config
st.set_page_config(page_title="PDF QA Bot (Gemini)", layout="wide")
st.title("PDF Question-Answer Bot — Gemini")
